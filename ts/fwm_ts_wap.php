...
<body>
	...
	//如果没有输入防伪码	
		if($bianhao == ""){		
			...
			echo "<script language='javascript'>layer.msg('查询条件不能为空！',{icon:0,time: 3000,shift: -1}, function(){location.href='../wap.php';});</script>";
			exit();
		}
		
		if($cf['yzm_status'] == 1 && $yzm != $_SESSION['authnum_session'])
		{
			echo "<script language='javascript'>layer.msg('验证码错误！',{icon:0,time: 3000,shift: -1}, function(){location.href='../wap.php';});</script>";	
			exit();
		}   
		...
		<div class="fwm_box">
			<div class="fwm_logo">
				<?php if($fwm == ""){ ?>
				<img src="images/fwm_f.png" alt="假货" />
				<?php } else{ ?>	
				<img src="images/fwm_t.png" alt="正品" />	
				<?php } ?>	
			</div>
			<?php if($hits>=$cf['fwm_max_so'] or $qiyong =="no"){ 
				...
				<a href="../wap.php" ><div class="goto">返&nbsp;&nbsp;&nbsp;&nbsp;回&nbsp;&nbsp;&nbsp;&nbsp;重&nbsp;&nbsp;&nbsp;&nbsp;查</div></a>
			</div>	
			<!--end -->  	
			<div class="fgx"></div>
			<div class="cl footer">版权所有：上海拉丽丝商贸有限公司 <a href="http://www.frangi.cn">www.frangi.cn</a></div>	  
		</BODY>
	</HTML>
	<?php 
